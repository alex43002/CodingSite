...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/pages/help/home.css" />
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
        <script src="https://animaapp.s3.amazonaws.com/launchpad-static/launchpad.js"></script>
        <link rel="stylesheet" type="text/css" href="/pages/help/styleguide.css" />
        <link rel="stylesheet" type="text/css" href="/pages/help/globals.css" />
    </head>
    <body style="margin: 0; background: #ffffff">
        ...
        <script type="text/javascript" src="/pages/help/AllFunctions.js">
