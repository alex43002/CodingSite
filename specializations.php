...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/pages/specializations/home.css" />
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
        <script src="https://animaapp.s3.amazonaws.com/launchpad-static/launchpad.js"></script>
        <link rel="stylesheet" type="text/css" href="/pages/specializations/styleguide.css" />
        <link rel="stylesheet" type="text/css" href="/pages/specializations/globals.css" />
    </head>
    <body style="margin: 0; background: #ffffff">
                ...
                <div class="header" id="header">
                    <div class="overlap-group1">
                        ...
                        <a href="https://example.com/">
                            <div class="login arial-regular-normal-white-16px">
                                Login
                            </div> 
                        </a>
                    </div>
        ...
        <script type="text/javascript" src="/pages/specializations/AllFunctions.js">
